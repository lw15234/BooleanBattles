...
struct enemy *createEnemy(int level)
{
    enemy enemyArray[LEVELS] = {
        {1, 1, "F",                     {  1,                       FILLER, FILLER, FILLER, FILLER, FILLER, FILLER, FILLER} , "enemies/uglygreentroll.bmp", "background.bmp", "questions/one.bmp" }, 
        {1, 1, "!F",                    {  0,                       FILLER, FILLER, FILLER, FILLER, FILLER, FILLER, FILLER} , "enemies/faun.bmp", "background.bmp", "questions/two.bmp" },
        {1, 1, "!!F",                   {  1,                       FILLER, FILLER, FILLER, FILLER, FILLER, FILLER, FILLER} , "enemies/goblin.bmp", "background.bmp", "questions/three.bmp" },
        {2, 1, "F && I",                { 11,                       FILLER, FILLER, FILLER, FILLER, FILLER, FILLER, FILLER} , "enemies/fox.bmp", "background.bmp", "questions/four.bmp" },
        {2, 3, "F || I",                {  1,  10,  11,                             FILLER, FILLER, FILLER, FILLER, FILLER} , "enemies/werewolf.bmp", "background.bmp", "questions/five.bmp" },
        {2, 3, "F || !I",               {  0,   1,  10,                             FILLER, FILLER, FILLER, FILLER, FILLER} , "enemies/vampire.bmp", "background.bmp", "questions/six.bmp" },
        {2, 3, "!(F && I)",             {  0,   1,  10,                             FILLER, FILLER, FILLER, FILLER, FILLER} , "enemies/ninja.bmp", "background.bmp", "questions/seven.bmp" },
        {3, 1, "F && I && L",           {111,                       FILLER, FILLER, FILLER, FILLER, FILLER, FILLER, FILLER} , "enemies/alien.bmp", "background.bmp", "questions/eight.bmp" },
        {3, 3, "(F || I) && L",         {101, 110, 111,                             FILLER, FILLER, FILLER, FILLER, FILLER} , "enemies/oneeyedmonster.bmp", "background.bmp", "questions/nine.bmp" },
        {3, 4, "(F && I) || (!I && L)", { 11, 100, 101, 111,                                FILLER, FILLER, FILLER, FILLER} , "enemies/weirdguy.bmp", "background.bmp", "questions/ten.bmp" },
    };
